package com.sanjay.leavemanagementsystem.config;

import com.sanjay.leavemanagementsystem.security.CustomUserDetailsService;
import com.sanjay.leavemanagementsystem.security.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/leaves/*/approve").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/leaves/*/reject").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow React running on any localhost Vite port
